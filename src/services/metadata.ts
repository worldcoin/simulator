...
async function precheckAction(request: MetadataParams): Promise<MetadataResponse | null> {
...
export async function fetchMetadata(request: MetadataParams): Promise<Partial<MetadataResponse>> {
