    ...
    <div className="mt-3 rounded-16 bg-gray-50 p-4">
      ...
      <div className="flex flex-col gap-3">
        <label
          ...
          htmlFor="v4-persona-document-type"
        >
          <span className="text-b4 text-gray-500">Document type</span>
          <select
            id="v4-persona-document-type"
        ...
        <label
          className="flex flex-col gap-1"
          htmlFor="v4-persona-document-number"
        >
          <span className="text-b4 text-gray-500">Document number</span>
          <Input
            id="v4-persona-document-number"
        ...
        <label
          className="flex flex-col gap-1"
          htmlFor="v4-persona-issuing-country"
        >
          <span className="text-b4 text-gray-500">Issuing country</span>
          <Input
            id="v4-persona-issuing-country"
        ...
        <label
          className="flex flex-col gap-1"
          htmlFor="v4-persona-full-name"
        >
          <span className="text-b4 text-gray-500">Full name</span>
          <Input
            id="v4-persona-full-name"
            value={form.fullName}
            placeholder=""
        ...
        <label
          className="flex flex-col gap-1"
          htmlFor="v4-persona-nationality"
        >
          <span className="text-b4 text-gray-500">Nationality</span>
          <Input
            id="v4-persona-nationality"
