...
export const Settings = memo(function Settings(props: {open: boolean; onClose: () => void; commitment: string}) {
  ...
  return (
    <Drawer fullHeight open={props.open} onClose={props.onClose}>
      <div className="flex h-full flex-col justify-between">
        <div>
          <Header heading="Settings" iconLeft="chevron-thick" onClickLeft={props.onClose} />
          <Item
            heading="Credentials"
          ...
          <Item
            ...
            className="mt-3 p-4"
            indicator={() => <Icon name="copy" className="h-6 w-6 text-gray-400" />}
            onClick={handleCopyCommitment}
          >
            <IconGradient name="note" color="#00C3B6" />
          </Item>
        </div>
        <Button
