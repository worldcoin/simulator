    ...
    <Drawer fullHeight open={props.open} onClose={props.onClose}>
      <div className="flex h-full flex-col">
        ...
        <div className="relative mt-10 flex items-center justify-center">
          ...
          <Image src="/images/orb.png" alt="The Worldcoin Orb" width={341} height={243} />
        </div>

        <h1 className="mt-24 text-center font-sora text-h1">Verify your identity</h1>
        <p className="mt-4 text-center text-b2 text-gray-500">
          Verifying your identity is the equivalent of going to a Worldcoin Orb and verifying you are a unique human.
        </p>
