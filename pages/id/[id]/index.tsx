    ...
    <div className="xs:gap-y-6 xs:pb-6 flex flex-col gap-y-4 px-2 pb-4">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <button className="rounded-12 bg-gray-100 p-4 text-left" onClick={() => setOpenQRInput(true)}>
          <IconGradient name="text" color="#191C20" className="h-6 w-6 text-white" bgClassName="h-[44px] w-[44px]" />
      ...
      <QRInput open={isOpenQRInput} onClose={() => setOpenQRInput(false)} performVerification={performVerification} />
