  ...
  const handleVerifyCredential = async (credentialType: CredentialType) => {
    ...
    try {
      ...
      if (response.status === 200) {
        toast.info(`Credential type '${credentialType.toString()}' already exists onchain!`)
    ...
    try {
      ...
      throw new Error(`Error verifying '${credentialType.toString()}' credential on chain '${identity.chain}'`)
    }
  }
